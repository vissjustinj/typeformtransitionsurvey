    ...
    return(
        <div>
            <div className="ui raised segment" id="getstarted">
                ...
                <iframe width="500" height="400" id="getstartedvid"src="https://www.youtube.com/embed/6JL2htnXq2g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
