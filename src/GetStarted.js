    ...
    return(
        <div>
            <div className="ui raised segment" id="getstarted" title="Automatically Write HS Transition Survey">
                ...
                <iframe width="60%" height="400" id="getstartedvid"src="https://www.youtube.com/embed/6JL2htnXq2g" title="Automatically Write HS Transition Survey" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
